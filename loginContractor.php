...
<div class="wrapper">
    ...
    session_start();
      if (ISSET($_SESSION['client']))
        echo "<li><a href='#'>Current Jobs</a></li>
          ...
          else if (ISSET($_SESSION['employee']) && $_SESSION['empType'] = "Contractor")
...
<h1 class="col-12" style="color:#163b58;">Login with your BIT Employee Username and Password</h1>
<form name="contractorLogin" method="post" onsubmit="validateContractorLogin()" action="contractorLogin.php">
